...
RUNTIME_REQUIRED_PATHS = [
    ...
    "scripts/policy_action_guard.py",
    ...
    "scripts/verify_effective_agent_policy.py",
    ...
    "scripts/sdk_policy_hook_poc.py",
    "scripts/validate_fab_agent.py",
    "scripts/validate_role_card.py",
    "tests/test_fab_agent_poc.py",
    "tests/test_fab_agent_policy.py",
    "tests/test_effective_agent_policy.py",
    "tests/test_policy_action_guard.py",
    "tests/test_materialize_artifact_package.py",
    "tests/test_role_card_policy.py",
    "tests/test_sdk_policy_hook_poc.py",
