...
def find_artifact_dir(run_dir: Path) -> Path:
    root_artifacts = run_dir / "ptt-stock-live"
    worktree_artifacts = run_dir / "worktree" / "ptt-stock-live"
    if root_artifacts.exists():
        return root_artifacts
    if worktree_artifacts.exists():
        return worktree_artifacts
    return root_artifacts
...
def verify_gate(gate: str, run_dir: Path) -> dict[str, Any]:
    ...
    details: dict[str, Any] = {
        ...
        "supported_artifact_roots": [
            str(run_dir / "ptt-stock-live"),
            str(run_dir / "worktree" / "ptt-stock-live"),
        ],
    }
